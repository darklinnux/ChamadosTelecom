...
$cadastrar = $this->controleacesso->verficaPermisaoCadastrar(6,true);
$editar = $this->controleacesso->verficaPermisaoEditar(6,true);
$remover = $this->controleacesso->verficaPermisaoRemover(6,true);
$listar = $this->controleacesso->verficaPermisaoListar(6,true);
?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header bg-red">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Remover Estado</h4>
              </div>
              <div class="modal-body">
                <p>Deseja realmente deletar esse Estado ?&hellip;</p>
              </div>
