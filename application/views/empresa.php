...
?>
  ...
  <div class="modal fade" id="modal-default">
        ...
        <!-- Modal editar -->
  <form action="<?=base_url('empresa/editar')?>" method="post" onsubmit="validarForm();">
  ...
  <div class="modal fade" id="modal-remover">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>Deseja realmente deletar essa Empresa ?&hellip;</p>
              </div>
...
<script>
  function modalEditar(id){
    ...
    consultar("<?=base_url('empresa/carregarDadosEditar/')?>"+id,(retorno) => {
      var empresa = JSON.parse(retorno);
      console.log(empresa.emp_id);
      $('#editar-nome').val(empresa.emp_nome);
      $('#editar-id').val(empresa.emp_id);
